...
public class GenerateTemplate {
    ...
    public GenerateTemplate(ApiClient apiClient){
        this.apiClient = apiClient;
    }

    void cancelGenerateTemplate(String id) {
    ...
    public OMRResponse getGenerateTemplate(String id) {
        Object postBody = null;
    ...
    public String postGenerateTemplate(OmrGenerateTask body) {
